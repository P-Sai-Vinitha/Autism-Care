...
class PointingSkill extends StatefulWidget {
  final String email;
  const PointingSkill({Key? key, required this.email}) : super(key: key);

  @override
  State<PointingSkill> createState() => _PointingSkillState();
}

class _PointingSkillState extends State<PointingSkill> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/pointing_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/pointingskill.php'; // Replace with your backend URL
...
void main() {
  runApp(MaterialApp(
    home: PointingSkill(email: 'example@example.com'), // Provide the email here
  ));
}
