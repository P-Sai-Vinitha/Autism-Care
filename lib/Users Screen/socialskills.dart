...
import '../ip.dart'; // Import your eye contact skill page

class SocialSkills extends StatefulWidget {
  final String email;

  const SocialSkills({Key? key, required this.email}) : super(key: key);
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  child: Center(
                    child: Text(
                      'Socializing or social rules may not be easy for your child even if it may be easy for you or others. So here is a video with some tips to help you train your child at home to cope better at social situations.',
