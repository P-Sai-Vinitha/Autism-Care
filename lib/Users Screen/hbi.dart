...
class hbi extends StatefulWidget {
  final String email;
  const hbi({Key? key,required this.email}) : super(key: key);

  @override
  State<hbi> createState() => _hbiState();
}

class _hbiState extends State<hbi> {
  @override
            ...
            Padding(
              ...
              child: OptionContainer(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => handlingbehavioralissues(email:widget.email ,)),
                  );
            ...
            Padding(
              ...
              child: OptionContainer(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => aggressivebehaviour(email:widget.email ,)),
                  );
            ...
            Padding(
              ...
              child: OptionContainer(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => repetitivebehaviour(email:widget.email ,)),
                  );
            ...
            Padding(
              ...
              child: OptionContainer(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => screaming(email:widget.email ,)),
                  );
...
class _OptionContainerState extends State<OptionContainer> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.title == 'Introduction' ||
        widget.title == 'Self Injurious Behaviour' ||
        widget.title == 'Aggressive Behaviour' ||
        widget.title == 'Repetitive Behaviour' ||
        widget.title == 'Screaming') {
