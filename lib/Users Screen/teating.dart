...
class teating extends StatefulWidget {
  final String email;
  const teating({Key? key,required this.email}) : super(key: key);

  @override
  State<teating> createState() => _teatingState();
}

class _teatingState extends State<teating> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/eating_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/eating.php'; // Replace with your backend URL
