...
class tbathing extends StatefulWidget {
  final String email;
  const tbathing({Key? key,required this.email}) : super(key: key);

  @override
  State<tbathing> createState() => _tbathingState();
}

class _tbathingState extends State<tbathing> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/bathing_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/bathing.php'; // Replace with your backend URL
