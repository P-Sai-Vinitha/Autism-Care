...
class selfhelpskills extends StatefulWidget {
  final String email;
  const selfhelpskills({Key? key,required this.email}) : super(key: key);

  @override
  State<selfhelpskills> createState() => _selfhelpskillsState();
}

class _selfhelpskillsState extends State<selfhelpskills> {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center( // Center the text
                    child: Text(
                      "Communication skills might pose challenges for your child, even though they appear effortless for you or others. To assist you in nurturing your child's communication abilities at home, we've prepared a video with practical tips aimed at enhancing their capacity to navigate social interactions more effectively.",
