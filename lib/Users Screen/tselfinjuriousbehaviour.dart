...
class tselfinjuriousbehaviour extends StatefulWidget {
  final String email;
  const tselfinjuriousbehaviour({Key? key,required this.email}) : super(key: key);

  @override
  State<tselfinjuriousbehaviour> createState() => _tselfinjuriousbehaviourState();
}

class _tselfinjuriousbehaviourState extends State<tselfinjuriousbehaviour> {
