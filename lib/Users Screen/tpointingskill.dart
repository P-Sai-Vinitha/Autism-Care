...
class tpointingskill extends StatefulWidget {
  final String email;
  const tpointingskill({Key? key,required this.email}) : super(key: key);

  @override
  State<tpointingskill> createState() => _tpointingskillState();
}

class _tpointingskillState extends State<tpointingskill> {
