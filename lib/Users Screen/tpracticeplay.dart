...
class tpracticeplay extends StatefulWidget {
  final String email;
  const tpracticeplay({Key? key,required this.email}) : super(key: key);

  @override
  State<tpracticeplay> createState() => _tpracticeplayState();
}

class _tpracticeplayState extends State<tpracticeplay> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/practice_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/practiceplay.php'; // Replace with your backend URL
