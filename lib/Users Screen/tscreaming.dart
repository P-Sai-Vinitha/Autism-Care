...
class tscreaming extends StatefulWidget {
  final String email;
  const tscreaming({Key? key,required this.email}) : super(key: key);

  @override
  State<tscreaming> createState() => _tscreamingState();
}

class _tscreamingState extends State<tscreaming> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/screaming_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/screaming.php'; // Replace with your backend URL
