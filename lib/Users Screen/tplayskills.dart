...
class tplayskills extends StatefulWidget {
  final String email;
  const tplayskills({Key? key,required this.email}) : super(key: key);

  @override
  State<tplayskills> createState() => _tplayskillsState();
}

class _tplayskillsState extends State<tplayskills> {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center( // Center the text
                    child: Text(
                      'மற்றவர்களுக்கு எளிதாகத் தோன்றினாலும் கூட, உங்கள் பிள்ளைக்கு சமூகமயமாக்கல் கடினமாக இருக்கலாம். உங்கள் குழந்தை சமூக சூழ்நிலைகளில் அதிக எளிதாகவும் நம்பிக்கையுடனும் செல்ல உதவ, வீட்டில் விளையாட்டு சிகிச்சையைப் பயன்படுத்துவதற்கான பயனுள்ள உதவிக்குறிப்புகளுக்கு எங்கள் வீடியோவைப் பார்க்கவும்.',
