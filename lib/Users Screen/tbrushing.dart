...
class tbrushing extends StatefulWidget {
  final String email;
  const tbrushing({Key? key,required this.email}) : super(key: key);

  @override
  State<tbrushing> createState() => _tbrushingState();
}

class _tbrushingState extends State<tbrushing> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/brushing_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/brushing.php'; // Replace with your backend URL
