...
class tjointattentionskill extends StatefulWidget {
  final String email;
  const tjointattentionskill({Key? key,required this.email}) : super(key: key);

  @override
  State<tjointattentionskill> createState() => _tjointattentionskillState();
}

class _tjointattentionskillState extends State<tjointattentionskill> {
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/jointattentionskill.php'; // Replace with your backend URL
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => tprogress(email: widget.email)),
                    );
                  },
