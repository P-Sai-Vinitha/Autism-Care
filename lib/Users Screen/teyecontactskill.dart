...
class teyecontactskill extends StatefulWidget {
  final String email;
  const teyecontactskill({Key? key,required this.email}) : super(key: key);

  @override
  State<teyecontactskill> createState() => _teyecontactskillState();
}

class _teyecontactskillState extends State<teyecontactskill> {
