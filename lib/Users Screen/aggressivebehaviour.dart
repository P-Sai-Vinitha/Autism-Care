...
class aggressivebehaviour extends StatefulWidget {
  final String email;
  const aggressivebehaviour({Key? key, required this.email}) : super(key: key);

  @override
  State<aggressivebehaviour> createState() => _aggressivebehaviourState();
}

class _aggressivebehaviourState extends State<aggressivebehaviour> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/aggressive_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/aggressivebehaviour.php'; // Replace with your backend URL
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              repetitivebehaviour(email: widget.email)),
                    );
