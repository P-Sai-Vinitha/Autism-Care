...
class newplayskills extends StatefulWidget {
  final String email;
  const newplayskills({Key? key,required this.email}) : super(key: key);

  @override
  State<newplayskills> createState() => _newplayskillsState();
}

class _newplayskillsState extends State<newplayskills> {
