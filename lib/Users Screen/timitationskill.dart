...
import 'package:autisa/Users%20Screen/tjointattentionskill.dart';
...
class timitationskill extends StatefulWidget {
  final String email;
  const timitationskill({Key? key,required this.email}) : super(key: key);

  @override
  State<timitationskill> createState() => _timitationskillState();
}

class _timitationskillState extends State<timitationskill> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/imitation_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/imitationskill.php'; // Replace with your backend URL
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => tjointattentionskill(email: widget.email)),
                    );
                  },
