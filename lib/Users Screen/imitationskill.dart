...
class ImitationSkill extends StatefulWidget {
  final String email;
  const ImitationSkill({Key? key, required this.email}) : super(key: key);

  @override
  State<ImitationSkill> createState() => _ImitationSkillState();
}

class _ImitationSkillState extends State<ImitationSkill> {
...
void main() {
  runApp(MaterialApp(
    home: ImitationSkill(email: 'example@example.com'), // Provide the email here
  ));
}
