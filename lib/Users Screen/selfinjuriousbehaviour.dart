...
class selfinjuriousbehaviour extends StatefulWidget {
  final String email;
  const selfinjuriousbehaviour({Key? key,required this.email}) : super(key: key);

  @override
  State<selfinjuriousbehaviour> createState() => _selfinjuriousbehaviourState();
}

class _selfinjuriousbehaviourState extends State<selfinjuriousbehaviour> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/self_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/selfinjuriousbehaviour.php'; // Replace with your backend URL
