...
class treinforcement extends StatefulWidget {
  final String email;
  const treinforcement({Key? key,required this.email}) : super(key: key);

  @override
  State<treinforcement> createState() => _treinforcementState();
}

class _treinforcementState extends State<treinforcement> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/reinforcement_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/reinforcement.php'; // Replace with your backend URL
