...
class trepetitivebehaviour extends StatefulWidget {
  final String email;
  const trepetitivebehaviour({Key? key,required this.email}) : super(key: key);

  @override
  State<trepetitivebehaviour> createState() => _trepetitivebehaviourState();
}

class _trepetitivebehaviourState extends State<trepetitivebehaviour> {
