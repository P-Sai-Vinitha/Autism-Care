...
class screaming extends StatefulWidget {
  final String email;
  const screaming({Key? key,required this.email}) : super(key: key);

  @override
  State<screaming> createState() => _screamingState();
}

class _screamingState extends State<screaming> {
