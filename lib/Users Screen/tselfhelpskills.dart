...
class tselfhelpskills extends StatefulWidget {
  final String email;
  const tselfhelpskills({Key? key,required this.email}) : super(key: key);

  @override
  State<tselfhelpskills> createState() => _tselfhelpskillsState();
}

class _tselfhelpskillsState extends State<tselfhelpskills> {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              SizedBox(height: 100),
              // Display "SELF HELP SKILLS" as text
              Text(
                'சுய உதவி திறன்',
                style: TextStyle(
                  fontSize: 24,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center( // Center the text
                    child: Text(
                      "உங்களுக்கோ மற்றவர்களுக்கோ சிரமமின்றித் தோன்றினாலும், தகவல் தொடர்புத் திறன் உங்கள் பிள்ளைக்கு சவால்களை ஏற்படுத்தலாம். வீட்டில் உங்கள் குழந்தையின் தகவல் தொடர்பு திறன்களை வளர்ப்பதில் உங்களுக்கு உதவ, சமூக தொடர்புகளை மிகவும் திறம்பட வழிநடத்தும் திறனை மேம்படுத்தும் நோக்கில் நடைமுறை உதவிக்குறிப்புகள் கொண்ட வீடியோவை நாங்கள் தயார் செய்துள்ளோம்.",
