...
class tnewplayskills extends StatefulWidget {
  final String email;
  const tnewplayskills({Key? key,required this.email}) : super(key: key);

  @override
  State<tnewplayskills> createState() => _tnewplayskillsState();
}

class _tnewplayskillsState extends State<tnewplayskills> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/newplay_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/newplayskill.php'; // Replace with your backend URL
