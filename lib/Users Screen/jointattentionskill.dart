...
class JointAttentionSkill extends StatefulWidget {
  final String email;
  const JointAttentionSkill({Key? key, required this.email}) : super(key: key);

  @override
  State<JointAttentionSkill> createState() => _JointAttentionSkillState();
}

class _JointAttentionSkillState extends State<JointAttentionSkill> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/jointattention_video.mp4');
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Progress(email: widget.email)),
                    );
                  },
