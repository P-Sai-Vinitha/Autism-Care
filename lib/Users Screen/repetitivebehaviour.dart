...
class repetitivebehaviour extends StatefulWidget {
  final String email;
  const repetitivebehaviour({Key? key,required this.email}) : super(key: key);

  @override
  State<repetitivebehaviour> createState() => _repetitivebehaviourState();
}

class _repetitivebehaviourState extends State<repetitivebehaviour> {
  ...
  Future<void> _fetchVideo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tempVideoFile = File('${tempDir.path}/repetitive_video.mp4');
  ...
  Future<void> sendDataToBackend() async {
    String url = '$ip/repetitivebehaviour.php'; // Replace with your backend URL
