...
class tuserprogress extends StatefulWidget {
  final String email;
  const tuserprogress({Key? key, required this.email}) : super(key: key);

  @override
  State<tuserprogress> createState() => _tuserprogressState();
}

class _tuserprogressState extends State<tuserprogress> {
              ...
              children: [
                Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text('சமூக திறன்',style: TextStyle(
                ...
                Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text('விளையாட்டு திறன்',style: TextStyle(
                      fontSize: 16, // Adjust the font size as per your preference
                    ),),
                  ],
                ),
