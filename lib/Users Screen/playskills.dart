...
class playskills extends StatefulWidget {
  final String email;
  const playskills({Key? key, required this.email}) : super(key: key);

  @override
  State<playskills> createState() => _playskillsState();
}

class _playskillsState extends State<playskills> {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center( // Center the text
                    child: Text(
                      'Socializing can be tough for your child, even if it seems easy for others. Watch our video for helpful tips on using play therapy at home to help your child navigate social situations with greater ease and confidence.',
